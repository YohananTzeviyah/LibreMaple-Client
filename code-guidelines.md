...
* Don't omit curly braces, even when they are optional:
    * Bad:
...
* Documentation comments (which should, with very few exceptions, be at the
  ...
  [Markdown](https://daringfireball.net/projects/markdown/) syntax:
     ...
     */
    void some_function(const Foo& foo) {
        // ...
    }
    ```
...
* **Use static analysis tools**. These include things like Cppcheck, Oink, etc.
...
* **Use runtime analysis tools**. These include things like AddressSanitizer,
  LeakSanitizer, ThreadSanitizer, MemorySanitizer,
